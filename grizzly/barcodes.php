        ...
        <tbody>
            <?php foreach ($barcodes as $barcode): ?>
                <tr>
                    ...
                    <td>
                        <?php
                        if ($barcode['user_id'] != 0) {
                            $user = $userManager->get_user_by_id($barcode['user_id']);
                    ...
                    <td>
                        <?php if ($barcode['user_id'] != 0): ?>
                            <span class="status-assigned">Dodeljen</span>
                        <?php else: ?>
                            <span class="status-free">Slobodan</span>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
